    ...
    foreach ($validate_rules as $input_key => $validate_rule) {
        ...
        foreach ($validate_rule['rules'] as $rule_name => $rule) {
            if ($rule_name === 'required') {
                $validate_empty_error_message = validate_required($input, $validate_rule['name'], $rule);
                if ($validate_empty_error_message !== '') {
                    $error_messages[] = $validate_empty_error_message;
                }
            }
