...
class Paginator
{
    ...
    private $one_page_item_count = 10;
    ...
    public function getOnePageItemCount()
    {
        return $this->one_page_item_count;
    }
    ...
    public function getMaxPageNum()
    {
        ...
        if ($this->total_item_count > 0) {
            $max_page_num = (int) ceil($this->total_item_count / $this->one_page_item_count);
        }
