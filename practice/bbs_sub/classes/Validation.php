...
// このクラスが他のファイルでも使用されることを想定してクラス化を行う。
// これって関数でもよくない？わざわざクラス化する必要があるの？
// このクラスのプロパティとしてバリデーションルールを定義するのは良くないことだろうか？
// 他のファイルでも使えるようにすることを考えるとバリデーションルールは他のフィルで定義することなのかな？
