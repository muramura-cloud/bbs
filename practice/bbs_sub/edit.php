...
if (isset($_POST['confirm-edit-btn']) && password_verify($password, $post['password'])) {
    ...
    <div class="board">
        ...
        <?php if (empty($error_message)) : ?>
            ...
            <form action="" method="post">
                ...
                <input name="confirm-edit-btn" type="submit" value="編集" class="confirm-delete-btn">
            </form>
        <?php else : ?>
            <p class="error_message"><?php echo $error_message ?></p>
            <div class="post-box">
